...
\usebackgroundtemplate{
   ...
   \end{tikzpicture}}
     \begin{frame}[fragile, environment=image]}
{\end{frame}}
...
% \frametitle{\textbf{\color{myred}\Large Chaospy: \\ \vspace{1mm} A modular implementation of polynomial\\ \vspace{1mm} chaos expansions and Monte Carlo methods}}
 ...
 \begin{tikzpicture}[remember picture,overlay]
    \node [xshift=0\paperwidth, yshift=-0.05\paperheight] at (current page.center)
          {\includegraphics[width = 0.73\paperwidth ]{network.jpeg}};
  \end{tikzpicture}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node [xshift=-2.8cm, yshift=0.55cm] at (current page.south east)
          {\includegraphics[width = 0.4\paperwidth ]{uio.png}};
  \end{tikzpicture}
...
\begin{frame}{Bakgrunn fra teoretisk astrofysikk}
   \begin{figure}
       {\includegraphics[width=0.9\textwidth]{galaxy.jpg}}
\end{figure}
\end{frame}
...
\vspace{-5mm}
   \begin{figure}
        \only<1>{\includegraphics[width=0.8\textwidth]{membrane.png}}
        \only<2>{\includegraphics[width=0.8\textwidth]{membraneNa.png}}
        \only<3>{\includegraphics[width=0.8\textwidth]{membraneA.png}}
\end{figure}
\end{frame}
...
% \begin{frame}{De elektriske signalene lages ved at det er forskjellig konsentrasjon av ioner }
%    \begin{figure}
...
\only<2->{\[I = C\frac{{\mathrm d} V}{{\mathrm d} t}  + {\bf\color{logored}I_{\text{kanaler}}}\]}
    \vspace{-5mm}
    \begin{figure}
   \only<3>{\includegraphics[width=0.8\textwidth]{hh_variation.png}}
   \end{figure}
\end{overlayarea}
\end{frame}

...
\begin{center}
\vspace{-40mm}
    \textbf{\color{myred}\LARGE Hvordan kan vi modelere hjernen med en datamaskin?}
    \vspace{3mm}
...
%             {\includegraphics[width = 0.2\textwidth]{logo_small.png}};
%       \node[align=left, opacity=0.35] at (image2.east) {\hspace{4cm} \bf Usikkerhet i nevrovitenskap};
%     \end{tikzpicture}
% \end{frame}
...
\begin{frame}
    \fullimage{number.png}{0.63}
\end{frame}

\begin{frame}
    \fullimage{synapse.png}{0.37}
\end{frame}
  ...
  % \vspace{10mm}
    ...
    \begin{column}{0.5\textwidth}
      \begin{overlayarea}{\textwidth}{\textheight}
        \begin{center}
        \begin{figure}
            \only<1,5->{\includegraphics[width=1.2\textwidth]{romlig.png}}
            \only<2>{\includegraphics[width=1.2\textwidth]{romlig_1.png}}
            \only<3>{\includegraphics[width=1.2\textwidth]{romlig_2.png}}
            \only<4>{\includegraphics[width=1.2\textwidth]{romlig_3.png}}
     \end{figure}
    \end{center}
  \end{overlayarea}
    \end{column}
    \begin{column}{0.5\textwidth}  %%<--- here
      \begin{overlayarea}{\textwidth}{\textheight}
        ...
        \begin{center}
          \only<5>{\includegraphics[width=1.1\textwidth]{tid.png}}
          \only<6>{\includegraphics[width=1.1\textwidth]{tid_1.png}}
          \only<7>{\includegraphics[width=1.1\textwidth]{tid_2.png}}
          \only<8>{\includegraphics[width=1.1\textwidth]{tid_3.png}}
         \end{center}
       \end{overlayarea}
    \end{column}
    \end{columns}
...
\begin{frame}{Ett nevron kan modeleres som en elektrisk krets}
        \begin{tikzpicture}[remember picture, overlay, font=\sffamily]
              \onslide<1->{\node [align=left, xshift=-0\textwidth,yshift=0.25\textwidth] (image3) at (current page.center)
                     {$I = C\frac{{\mathrm d} V}{{\mathrm d} t}  + {\bf\color<2>{logored}I_{\text{kanaler}}}$};}
           \end{tikzpicture}
...
\begin{frame}
    \fullimage{point_neuron.png}{0.2}
\end{frame}

\begin{frame}
    \fullimage{neuron2.png}{0.7}
\end{frame}
...
\begin{frame}{Mange kretser kan settes sammen til et nevron med utstrekning}
  \begin{overlayarea}{\textwidth}{\textheight}
   ...
   \begin{figure}
    ...
    %  \only<3>{\[\frac{1}{r_l} \frac{\partial ^2 V}{\partial x^2}=c_m \frac{\partial V}{\partial t}+\frac{V}{r_m}\]}
\end{figure}
\begin{figure}
  \only<3>{\includegraphics[width=1\textwidth]{cable.png}}
\end{figure}
\end{overlayarea}
\end{frame}


% slide med vi forstår ikke hjernen med å regen ut hva ett nevron er, hviodo ønsker å se på netverk
...
\begin{frame}[fragile]{}
  ...
  \end{tikzpicture}
    ...
    \begin{tikzpicture}[remember picture, overlay, font=\sffamily]
      \node [align=left,  xshift=0\textwidth,yshift=-0.25\textwidth] (image2) at (current page.center)
            {\includegraphics[width = 0.2\textwidth]{logo_small.png}};
      \node[align=left] at (image2.east) {\hspace{4cm} \bf Usikkerhet i nevrovitenskap};
    \end{tikzpicture}
\end{frame}
...
\begin{frame}%{2 årsaker til usikkerhet: måleusikkerthet}
  \fullimage{measurement.jpg}{0.3}
\end{frame}

\begin{frame}%{2 årsaker til usikkerhet: biologiske parametre varierer}
  \only<1>{\fullimage{height2.png}{0.2}}
  \only<2>{\fullimage{height_distribution.png}{1.1}}
\end{frame}
...
\begin{frame}
    ...
    \only<3>{\fullimage{probabalistic.png}{.35}}
\end{frame}
...
\begin{tikzpicture}[remember picture, overlay, font=\sffamily]
  ...
  \node[align=left, yshift=.05\textwidth, opacity=0.9] at (current page.south){ \bf \large Takk for meg!};
\end{tikzpicture}

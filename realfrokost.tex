...
\begin{frame}
    \fullimage{number.png}{0.4}
\end{frame}

\begin{frame}
    \fullimage{synapse.png}{0.2}
\end{frame}
...
\begin{frame}{}
    ...
    \begin{column}{0.5\textwidth}
        \begin{center}
        \begin{figure}
            \only<1,5->{\includegraphics[width=1\textwidth]{romlig.png}}
            \only<2>{\includegraphics[width=1\textwidth]{romlig_1.png}}
            \only<3>{\includegraphics[width=1\textwidth]{romlig_2.png}}
            \only<4>{\includegraphics[width=1\textwidth]{romlig_3.png}}
     \end{figure}
    \end{center}
    \end{column}
    \begin{column}{0.5\textwidth}  %%<--- here
        \begin{center}
          \only<5>{\includegraphics[width=1\textwidth]{tid.png}}
          \only<6>{\includegraphics[width=1\textwidth]{tid_1.png}}
          \only<7>{\includegraphics[width=1\textwidth]{tid_2.png}}
          \only<8>{\includegraphics[width=1\textwidth]{tid_3.png}}
         \end{center}
    \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \only<1>{\fullimage{deterministic.png}{.45}}
\end{frame}
